...
description: 'On task completion, codify the "should-have-known-it" insight from trial-and-error as an ast-grep rule, skill, or CLAUDE.md rule. Trigger phrases: "codify today''s lessons," "make it a skill," "drop it into lint."'
---

> Source: mizchi/skills retrospective-codify (https://github.com/mizchi/skills/tree/main/retrospective-codify)
